              ...
              >
                ...
                <span
                  className={`absolute left-3.5 right-3.5 -bottom-0.5 h-px bg-emerald-azure origin-left transition-transform duration-300 ${
                    active === item.id && location.pathname === '/' ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                  }`}
                />
              </button>
            </li>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="lg:hidden overflow-hidden glass border-t border-white/10 mt-3"
          >
                ...
                <li key={item.id}>
                  <button
                    ...
                    className={`w-full text-left py-2.5 ${
                      active === item.id ? 'text-emerald-glow' : 'text-ink-muted'
                    }`}
                  >
                    {item.label}
                  </button>
