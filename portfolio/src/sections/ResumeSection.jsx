  ...
  return (
    <section id="resume" className="section-pad relative">
      <div className="container-px max-w-6xl mx-auto">
        <SectionHeading path="resume/pravin_kumar.pdf" title="One page. ATS-ready. Always current." />
        ...
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-10 items-center">
          ...
          >
            <p className="font-mono text-xs text-ink-faint mb-4 font-mono-caption">ATS-FRIENDLY HIGHLIGHTS</p>
            <ul className="space-y-3">
              {resumeHighlights.map((h) => (
                <li key={h} className="flex items-start gap-3 text-sm text-ink-muted">
                  <FiCheckCircle className="text-emerald-glow mt-0.5 shrink-0" size={16} />
                  {h}
                </li>
              ))}
            </ul>
