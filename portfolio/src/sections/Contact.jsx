...
function validate(form) {
  ...
  if (!form.message.trim()) errors.message = "Message is required";
    ...
    errors.message = "Say a little more (10+ characters)";
  return errors;
}
    ...
    <section id="contact" className="section-pad relative">
      <div className="container-px max-w-6xl mx-auto">
        <SectionHeading
          ...
          description="Open to full-time SDE roles, freelance MERN work, and interesting problems in general."
        />
        ...
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-10">
          ...
          <div className="space-y-4">
            <a
              ...
              className="flex items-center gap-3.5 glass rounded-2xl p-5 hover:border-emerald-glow/40 transition-colors"
            >
              <span className="w-10 h-10 rounded-xl bg-emerald-azure/15 flex items-center justify-center text-emerald-glow shrink-0">
                <FiMail size={17} />
              </span>
          ...
          >
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                <label
                  htmlFor="name"
                  className="block text-xs font-mono text-ink-faint mb-2"
                >
                  NAME
                </label>
                <input
